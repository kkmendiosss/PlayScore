...
-- A despejar dados para tabela playscore.avaliacoes: ~3 rows (aproximadamente)
...
-- A despejar dados para tabela playscore.contactos: ~2 rows (aproximadamente)
...
-- A despejar dados para tabela playscore.generos: ~14 rows (aproximadamente)
...
-- A despejar dados para tabela playscore.jogos: ~21 rows (aproximadamente)
INSERT INTO `jogos` (`id_jogo`, `titulo`, `desenvolvedor`, `editor`, `descricao`, `data_lancamento`, `capa_url`, `trailer_url`, `plataforma`, `classificacao`, `id_genero`, `id_franquia`, `num_votos`, `soma_classificacao`) VALUES
	...
	(3, 'God of War', 'SIE Santa Monica Studio', 'Sony Interactive Entertainment', 'God of War is the sequel to God of War III as well as a continuation of the canon God of War chronology. Unlike previous installments, this game focuses on Norse mythology and follows an older and more seasoned Kratos and his son Atreus in the years since the third game. It is in this harsh, unforgiving world that he must fight to survive… and teach his son to do the same.', '2018-04-20', '../uploads/capas/1781648561_cobkt6.jpg', 'https://www.youtube.com/embed/K0u_kAWLJOA?si=ohApk1TO4l0syoyx', 'PC', NULL, 5, 1, 0, 0),
	(4, 'Outer Wilds', 'Mobius Digital', 'Annapurna Interactive', 'Outer Wilds is a critically-acclaimed and award-winning open world mystery about a solar system trapped in an endless time loop. The newest member of the space program in a small village on the planet Timber Hearth, the player navigates a space shuttle and travels across their solar system to get to the bottom of its mysteries by exploring the cosmos and gathering the knowledge hidden within each of the system\'s planets, left behind by another civilization in the distant past.', '2019-05-28', '../uploads/capas/1781648487_co65ac.jpg', 'https://www.youtube.com/embed/ZKJUMMCJvGM?si=1N0iu_oNJn93l6Lm', 'PC, PlayStation 5, Xbox Series X/S, Nintendo Switch', NULL, 6, NULL, 0, 0),
	(5, 'Bloodborne', 'FromSoftware', 'Sony Computer Entertainment', 'An action RPG in which the player embodies a Hunter who, after being transfused with the mysterious blood local to the city of Yharnam, sets off into a "night of the Hunt", an extended night in which Hunters may phase in and out of dream and reality in order to thin the outbreak of abominable beasts that plague the land and, for the more resilient and insightful Hunters, uncover the answers to the Hunt\'s many mysteries.', '2015-03-24', '../uploads/capas/1781648414_cob99l.jpg', 'https://www.youtube.com/embed/2Crk_GpxGQE?si=VBLtpAl7B-Q3fsIg', 'PlayStation 5', NULL, 3, NULL, 0, 0),
	(6, 'Disco Elysium', 'ZA/UM', 'ZA/UM', 'Disco Elysium is a role-playing game developed and published by ZA/UM. It is set in the fictional city of Revachol, where players assume the role of an amnesiac detective investigating a murder case. The game emphasises dialogue and skill-based choices, with character attributes represented by internal voices that influence decisions and interactions. Its narrative explores themes of politics, philosophy, and personal identity, and it is known for its unconventional gameplay and deep storytelling.', '2019-10-15', '../uploads/capas/1781648335_co1sfj.jpg', 'https://www.youtube.com/embed/nk_K5DM0UTk?si=FAreSGNyU4foKZOM', 'PC, PlayStation 5, Xbox Series X/S, Nintendo Switch, Mobile', NULL, 3, NULL, 0, 0),
...
-- A despejar dados para tabela playscore.jogo_genero: ~37 rows (aproximadamente)
...
-- A despejar dados para tabela playscore.lancamentos: ~22 rows (aproximadamente)
